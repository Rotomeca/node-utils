...
describe("guard", () => {
  ...
  describe("isPlainObject", () => {
    it("Retourne true pour un objet littéral", () => {
    ...
    it("Retourne true pour new Object()", () => {
      expect(isPlainObject(new Object())).toBe(true);
    });

    it("Retourne true pour Object.create(null)", () => {
    ...
    it("Retourne false pour une instance de Date", () => {
      expect(isPlainObject(new Date())).toBe(false);
    });

    it("Retourne false pour une instance de RegExp", () => {
      expect(isPlainObject(/regex/)).toBe(false);
    });

    it("Retourne false pour une instance de Map", () => {
      expect(isPlainObject(new Map())).toBe(false);
    });

    it("Retourne false pour une instance de Set", () => {
      expect(isPlainObject(new Set())).toBe(false);
    });

    it("Retourne false pour une instance de Error", () => {
      expect(isPlainObject(new Error())).toBe(false);
    });

    it("Retourne false pour une instance de classe custom", () => {
      class MyClass {
        x = 1;
      }
    ...
    it("Retourne false pour une fonction", () => {
      expect(isPlainObject(() => {})).toBe(false);
    });
  });
